...
<form accept-charset="utf8" class="form-horizontal">
    ...
    <div class="col-md-8 col-md-offset-0">
        <div class="list-group">
            <a href="#" class="list-group-item active" style="width: 500px">Presupuestos de Compras por Fecha</a>              
        </div>   
...
<script>
    function enviar() {
        window.open("/sysmeli/informes/compras/presupuestos/imprimir.php?vdesde=" + $('#desde').val() + '&vhasta=' + $('#hasta').val() + '&vop=' + $('#op').val(), '_blank');
    }
</script>
