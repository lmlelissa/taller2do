...
<html lang="es">
    ...
    <form accept-charset="utf8" class="form-horizontal">
        <div class="col-md-8 col-md-offset-0">
            <div class="list-group">
                <a href="#" class="list-group-item active" style="width: 200px;">Pedidos de Compras</a>              
            </div>   
    ...
    <script>
        function obtener_fecha() {
            $.ajax({
                type: "POST",
                url: "/sysmeli/informes/compras/pedidos/porfecha.php/",
                cache: false,
                beforeSend: function () {
        ...
        function obtener_estado() {
            $.ajax({
                type: "POST",
                url: "/sysmeli/informes/compras/pedidos/porestado.php/",
                cache: false,
                beforeSend: function () {
                    $('#cargando').html('<img src="/sysmeli/dist/img/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
                },
