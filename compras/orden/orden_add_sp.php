...
<HTML>
    <HEAD>
        ...
        <title> Agregar Orden Sin Pedido</title>
        <?php
                            ...
                            <div class="box box-primary">
                                ...
                                <form action="orden_control.php" method="POST" accept-charset="UTF-8">
                                    <div class="box-body">
                                        ...
                                        <input type="hidden" name="vpresu" value="null"/>
                                        <input type="hidden" name="vped" value="null"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="vproveedor" required="">
                                                ...
                                                if (!empty($prvs)) {
                                                    foreach ($prvs as $prv) {
                                                        ?>
                                                        <option value="<?php echo $prv['id_proveedor']; ?>">
                                                            <?php echo $prv['prv_razonsocial']; ?></option>
                                                        <?php
                                                    }
                                                } else {
                                                    ?>
