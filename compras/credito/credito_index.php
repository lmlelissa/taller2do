                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            <?php
                                            $consultagral = consultas::get_datos("SELECT * FROM v_compras_credito WHERE id_sucursal=" . $_SESSION['id_sucursal'] . " ORDER BY id_nota");
                                                                        ...
                                                                        <form action="credito_detalle.php" method="GET">
                                                                            ...
                                                                            <?php if ($p['nc_estado'] == 'PENDIENTE') { ?>
                                                                                ...
                                                                                if (!empty($consultadetalle)) {
                                                                                    ?>
                                                                                    <a href="credito_confirmar.php?vidnota=<?php echo $p['id_nota'] . "&vcompra=" . $p['id_compra']; ?>" 
                                                                            ...
                                                                            <?php if ($p['nc_estado'] == 'CONFIRMADO') { ?>
                                                                                <a href="credito_anular.php?vidnota=<?php echo $p['id_nota'] . "&vcompra=" . $p['id_compra']; ?>" 
