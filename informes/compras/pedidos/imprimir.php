...
if ($_REQUEST['vop'] == '1') {
    $pedidos = consultas::get_datos("select * from v_compras_pedidos where pc_fecha BETWEEN '" . $_REQUEST['vdesde'] . "' AND '" . $_REQUEST['vhasta'] . "'");
    if (!empty($pedidos)) {
        foreach ($pedidos as $pedido) {
            ...
            $pdf->Cell(50, 5, $pedido['pc_estado'], 0, 0, 'C', 1);
...
if ($_REQUEST['vop'] == '2') {
    $pedidos = consultas::get_datos("select * from v_compras_pedidos where pc_estado ='" . $_REQUEST['vestado'] . "'");
    if (!empty($pedidos)) {
        foreach ($pedidos as $pedido) {
            $pdf->SetFont('', 'B', 10);
            $pdf->SetFillColor(180, 180, 180);
