...
<HTML>
    <HEAD>
        ...
        <title>AV - Confirmar Remision</title>
        <?php
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Confirmar Remision de Productos</h3>
                                    <div class="box-tools">
                                ...
                                <div class="box-body">
                                    <form action="controlador.php" method="POST" accept-charset="UTF-8" role="form">
                                        ...
                                        <input type="hidden" name="vnr_estado" value="TERMINADO"/>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="vsucursal_entrada"><i class="fa fa-map"></i>Remitente</label>
