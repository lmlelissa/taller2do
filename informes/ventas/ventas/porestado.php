...
<form accept-charset="utf8" class="form-horizontal">
    ...
    <div class="col-md-8 col-md-offset-0">
        <div class="list-group">
            <a href="#" class="list-group-item active" style="width: 280px">Ventas por Estado</a>              
        </div>   
        <div class="form-group col-md-12">
            ...
            <div class="col-md-4">
                <select class="form-control" id="vestado">
                    ...
                    <option value="CONFIRMADO">TERMINADO</option>
...
<script>
    function enviar() {
        window.open("/sysmeli/informes/ventas/ventas/imprimir.php?vestado=" + $('#vestado').val() + '&vop=' + $('#op').val(), '_blank');
    }
</script>
