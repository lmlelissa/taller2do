...
<html lang="es">
    ...
    <form accept-charset="utf8" class="form-horizontal">
        <div class="col-md-8 col-md-offset-0">
            <div class="list-group">
                <a href="#" class="list-group-item active" style="width: 200px;">Ventas</a>              
            </div>   
                                ...
                                <div class="row">                                        
                                    <div class="col-md-4 col-md-offset-0">
                                        <div class="list-group">
                                            ...
                                            <a href="#" onclick="obtener_cliente();" class="list-group-item" style="width: 200px;">Por Cliente</a>
                                        </div>                                                
                                    </div>
                                    <div id="cargando">
    ...
    <script>
        function obtener_fecha() {
            $.ajax({
                type: "POST",
                url: "/sysmeli/informes/ventas/ventas/porfecha.php/",
                cache: false,
                beforeSend: function () {
        ...
        function obtener_estado() {
            $.ajax({
                type: "POST",
                url: "/sysmeli/informes/ventas/ventas/porestado.php/",
                cache: false,
                beforeSend: function () {
                    $('#cargando').html('<img src="/sysmeli/dist/img/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
                },
        ...
        function obtener_cliente() {
            $.ajax({
                type: "POST",
                url: "/sysmeli/informes/ventas/ventas/porcliente.php/",
                cache: false,
                beforeSend: function () {
                    $('#cargando').html('<img src="/sysmeli/dist/img/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
                },
