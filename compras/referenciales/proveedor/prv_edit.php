                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="prv_index.php" class="btn btn-primary pull-right btn-sm">
                                ...
                                <form action="prv_control.php" method="POST" accept-charset="UTF-8">
                                    <div class="box-body">
                                        ...
                                        <input type="hidden" name="vidproveedor" value="<?php echo $resultado[0]['id_proveedor']; ?>"/> 
                                        <div class="form-group">
                                            <label >Ruc</label>
                                            <input class="form-control" type="text" name="vruc" required="" value="<?php echo $resultado[0]['prv_ruc']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Razon Social</label>
                                            <input class="form-control" type="text" name="vrazon" required="" value="<?php echo $resultado[0]['prv_razonsocial']; ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="vtelefono" required="" value="<?php echo $resultado[0]['prv_telefono']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input class="form-control" type="email" name="vemail" required="" value="<?php echo $resultado[0]['prv_correo']; ?>"> 
                                        </div>
                                        <div class="form-group">
                                            <label >Ciudad</label>
