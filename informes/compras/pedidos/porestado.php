...
<form accept-charset="utf8" class="form-horizontal">
    ...
    <div class="col-md-8 col-md-offset-0">
        <div class="list-group">
            <a href="#" class="list-group-item active" style="width: 280px">Pedidos de Compras por Estado</a>              
        </div>   
...
<script>
    function enviar() {
        window.open("/sysmeli/informes/compras/pedidos/imprimir.php?vestado=" + $('#vestado').val() + '&vop=' + $('#op').val(), '_blank');
    }
</script>
